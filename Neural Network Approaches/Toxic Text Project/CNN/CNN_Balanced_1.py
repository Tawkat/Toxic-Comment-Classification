...
model=create_model_CNN(dimension,vocabulary_size,embedding_size,embedding_matrix,nb_filter,filter_length)
history=model.fit(X_train,y_train,batch_size=512,epochs=10,validation_split=0.2,shuffle=True,callbacks=cb)

print("Saving Model...")
model_name = 'Models/CNN/Balanced/Model_CNN_balanced_1_class_6_sigmoid_binary_crossentropy.h5'#######################
model.save(model_name)

plot_loss_accu(history,lossLoc='Graph/CNN/Balanced/Train_Val_Loss_balanced_1_class_6_sigmoid_binary_crossentropy',
               accLoc='Graph/CNN/Balanced/Train_Val_acc_balanced_1_class_6_sigmoid_binary_crossentropy')


'''model_1=create_model_CNN(dimension,vocabulary_size,embedding_size,embedding_matrix,nb_filter,filter_length)
model_1.load_weights(model_name)
model_1.name = 'model_1' '''
model_1=load_model('Models/CNN/Balanced/Model_CNN_balanced_1_class_6_sigmoid_binary_crossentropy.h5')
...
import pickle
with open('Predictions/CNN/Balanced/CNN_balanced_1_class_6_sigmoid_binary_crossentropy.pickle','wb') as f:
    pickle.dump((y_test,pred,pred_binary),f)

pickle_load='Predictions/CNN/Balanced/CNN_balanced_1_class_6_sigmoid_binary_crossentropy.pickle'
